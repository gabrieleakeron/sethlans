...
import { BookOpen, ChevronLeft, Icon, RefreshCw, Wifi, WifiOff , Hammer, Palette} from "lucide-react";
...
export default function App() {
  const [page, setPage] = useState("agenda"); // 'agenda' | 'story' | 'knowledge' | 'design-system'
